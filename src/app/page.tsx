...
export const metadata = {
  ...
  description: 'Join our epic bike journey from Key West, FL to Los Angeles, CA to Flagstaff, AZ, connecting with veterans in 47 communities. Rolling 4 Purpose, Health, Discovery, and Veterans. Feb 27 - June 22, 2026.',
};
