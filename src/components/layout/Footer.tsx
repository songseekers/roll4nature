...
export default function Footer() {
  ...
  return (
    <footer className="bg-r4n-forest dark:bg-r4n-charcoal text-r4n-warm-cream">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
          ...
          <div className="col-span-1 text-center">
            <h4 className="text-r4n-warm-cream font-semibold mb-4">
              Roll 4 Nature
            </h4>
            ...
            <p className="text-r4n-warm-cream-dim text-sm">
              Get outside. Answers are found outdoors. Discover purpose in nature.
            </p>
          </div>
          ...
          <div className="col-span-1 md:col-span-2">
            <div className="grid grid-cols-2 gap-x-8 gap-y-2 ml-5">
              ...
              {/* Left Column */}
              <div>
                <h4 className="text-r4n-warm-cream font-semibold mb-4">Quick Links</h4>
                <ul className="space-y-2 text-sm">
                  <li>
                    <a href="https://gofund.me/fdff623ca" target="_blank" rel="noopener noreferrer" className="text-r4n-warm-cream-dim hover:text-r4n-primary-hover transition">DONATE</a>
                  </li>
                  <li>
                    <a href="https://c2c2c.songseekers.org" target="_blank" rel="noopener noreferrer" className="text-r4n-warm-cream-dim hover:text-r4n-primary-hover transition">Coast to Coast to Canyon Archive</a>
                  </li>
                  <li>
                    <a href="/partner" className="text-r4n-warm-cream-dim hover:text-r4n-primary-hover transition">Partner with Us</a>
                  </li>
                  <li>
                    <a href="/team-bravo" className="text-r4n-warm-cream-dim hover:text-r4n-primary-hover transition">Join Team Bravo</a>
                  </li>
                </ul>
              </div>
              ...
              {/* Right Column */}
              <div>
                <h4 className="text-r4n-warm-cream font-semibold mb-4">Team RWB</h4>
                <ul className="space-y-2 text-sm">
                  <li>
                    <a href="https://www.zeffy.com/en-US/team/roll-for-veterans" target="_blank" rel="noopener noreferrer" className="text-r4n-warm-cream-dim hover:text-r4n-primary-hover transition">Donate to Team RWB</a>
                  </li>
                  <li>
                    <a href="https://teamrwb.org/who-we-are/our-community" target="_blank" rel="noopener noreferrer" className="text-r4n-warm-cream-dim hover:text-r4n-primary-hover transition">Team RWB Official Page</a>
                  </li>
                  <li>
                    <a href="https://teamrwb.org/find-your-chapter" target="_blank" rel="noopener noreferrer" className="text-r4n-warm-cream-dim hover:text-r4n-primary-hover transition">Find a Chapter</a>
                  </li>
                  <li>
                    <a href="https://members.teamrwb.org/registration" target="_blank" rel="noopener noreferrer" className="text-r4n-warm-cream-dim hover:text-r4n-primary-hover transition">Join Team RWB</a>
                  </li>
                </ul>
              </div>
            </div>
          ...
          {/* Contact */}
          <div>
            <h4 className="text-r4n-warm-cream font-semibold mb-4">Book time or send an email</h4>
            <div className="flex gap-3 mb-4">
              ...
              <a
                ...
                className="flex items-center justify-center text-r4n-warm-cream-dim hover:text-r4n-primary-hover transition bg-r4n-forest-mid dark:bg-r4n-charcoal-mid p-3 rounded-lg hover:bg-r4n-forest-light dark:hover:bg-r4n-charcoal w-12 h-12"
                aria-label="Email Roll 4 Nature"
              >
                <Mail size={24} />
              </a>
            </div>
        ...
        <div className="border-t border-r4n-forest-mid dark:border-r4n-charcoal-mid pt-8 mb-8">
          <h4 className="text-r4n-warm-cream font-semibold text-center mb-6">Follow the Journey</h4>
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
            ...
            <div className="bg-r4n-forest-mid dark:bg-r4n-charcoal-mid rounded-lg p-5 flex flex-col items-center gap-3 border border-r4n-primary/30">
              ...
              <div className="flex flex-wrap justify-center gap-2">
                <a href="https://www.instagram.com/boogaliebear?igsh=MWM2dTk3M3prYXN5Yg==" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 text-r4n-warm-cream-dim hover:text-r4n-primary-hover transition bg-r4n-forest-light dark:bg-r4n-charcoal hover:bg-r4n-forest dark:hover:bg-r4n-charcoal-mid px-3 py-2 rounded-lg" aria-label="Follow Boogs on Instagram">
                  <Instagram size={18} />
        ...
        <div className="py-4 text-center">
          <a href="https://facebook.com/roll4nature" target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-2 text-sm text-r4n-warm-cream-dim hover:text-r4n-primary-hover transition">
            <MapPin size={16} />
        ...
        {/* Bottom */}
        <div className="border-t border-r4n-forest-mid dark:border-r4n-charcoal-mid pt-8">
          <div className="flex flex-col items-center">
            <p className="text-r4n-warm-cream-dim text-sm text-center">
          ...
          {/* RWB Mission */}
          <div className="mt-6 pt-6 border-t border-r4n-forest-mid dark:border-r4n-charcoal-mid">
            <div className="flex flex-col md:flex-row items-center justify-center gap-6">
              <a href="https://www.zeffy.com/en-US/team/roll-for-veterans" target="_blank" rel="noopener noreferrer" className="flex-shrink-0">
                <Image src="/images/rwb_ob_white.png" alt="Team Red, White, and Blue Logo" width={104} height={104} className="object-contain opacity-70 hover:opacity-100 transition" />
              </a>
              <p className="text-r4n-warm-cream-dim text-sm text-center md:text-left max-w-2xl">
                Team Red, White, and Blue (RWB) is a nonprofit organization dedicated to enriching the lives of
          ...
          <div className="mt-6 pt-6 border-t border-r4n-forest-mid dark:border-r4n-charcoal-mid">
            <div className="flex flex-col md:flex-row items-center justify-center gap-8">
              <a href="https://bexarlabs.co" target="_blank" rel="noopener noreferrer" className="flex flex-col md:flex-row items-center gap-4 group">
                ...
                <span className="text-r4n-warm-cream-dim text-sm text-center md:text-left group-hover:text-r4n-warm-cream transition">Website foundation and initial development</span>
              </a>
              <a href="https://www.anthropic.com" target="_blank" rel="noopener noreferrer" className="flex flex-col md:flex-row items-center gap-4 group">
                ...
                <span className="text-r4n-warm-cream-dim text-sm text-center md:text-left group-hover:text-r4n-warm-cream transition">AI-assisted design and development powered by Claude Sonnet 4.6 and Opus 4.6</span>
              </a>
            </div>
          </div>
        </div>
